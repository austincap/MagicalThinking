...
Object.defineProperties(TextManager, {
    ...
    talkVictory     : TextManager.getter('message', 'talkVictory'),
    talkDefeat      : TextManager.getter('message', 'talkDefeat')
});
...
BattleManager.playTalkVictoryMe = function() {
    AudioManager.playMe($gameSystem.talkVictoryMe());
};
...
BattleManager.displayTalkDefeatMessage = function() {
    $gameMessage.add(TextManager.talkDefeat.format($gameParty.name()));
};
